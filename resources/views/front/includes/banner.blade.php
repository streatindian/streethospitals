                        ...
                        <div class="item-search-tabs">
                            <div class="item-search-menu">
                                <ul class="nav">
                                    ...
                                    @foreach ($category as $ck => $c)
                                        <li class="">
                                            <a class="{{ $ck == 0 ? 'active' : '' }}" data-toggle="tab"
                                                href="#tab{{ $c->slug }}">{{ $c->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="tab-content index-search-select">
                                <div class="tab-pane active" id="tabhospitals">
                                    <form action="{{ route('find.listing') }}">
                                        ...
                                        <div class="search-background">
                                            <div class="form row no-gutters">
                                                ...
                                                <div class="form-group col-xl-2 col-lg-2 col-md-12 mb-0">
                                                    <button class="btn btn-block btn-orange fs-14" type="submit"><i
                                ...
                                <div class="tab-pane" id="tabfitnescenter">
                                    <form action="{{ route('find.listing') }}">
                                        <input type="hidden" value="fitness" name="type">
                                        <div class="search-background">
                                            <div class="form row no-gutters">
                                                <div class="form-group col-xl-4 col-lg-4 col-md-12 mb-0 location">
                                                    <div class="form-group mb-0">
                                ...
                                <div class="tab-pane" id="tabmassage-parlours">
                                    <form action="{{ route('find.listing') }}">
                                        <input type="hidden" value="parlour" name="type">
                                        <div class="search-background">
                                            <div class="form row no-gutters">
                                                <div class="form-group col-xl-4 col-lg-4 col-md-12 mb-0 location">
                                                    <div class="form-group mb-0">
                                ...
                                <div class="tab-pane" id="tabclinics">
                                    <form action="{{ route('find.listing') }}">
                                        <input type="hidden" value="clinics" name="type">
                                        <div class="search-background">
                                            <div class="form row no-gutters">
                                                <div class="form-group col-xl-4 col-lg-4 col-md-12 mb-0 location">
                                                    <div class="form-group mb-0">
                                ...
                                <div class="tab-pane" id="tabbloodbanks">
                                    <form action="{{ route('find.listing') }}">
                                        <input type="hidden" value="bloodbank" name="type">
                                        <div class="search-background">
                                            <div class="form row no-gutters">
                                                <div class="form-group col-xl-4 col-lg-4 col-md-12 mb-0 location">
                                                    <div class="form-group mb-0">
