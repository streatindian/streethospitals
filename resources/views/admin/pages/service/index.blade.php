    ...
    <div class="app-content  my-3 my-md-5">
        <div class="side-app">
            <div class="page-header">
                <h1 class="page-title">Service <a class="btn btn-sm btn-primary text-white"
                        href="{{ route('service.create') }}">Add Service</a></h1>
                <ol class="breadcrumb">
...
@section('js')
    ...
    <script>
        ...
        datatableInit("myTable", "{{ route('service.listing') }}", ['name', 'icon', 'banner',
