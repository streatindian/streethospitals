                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="permission[{{ $permission->name }}]"
                                                            value="{{ $permission->name }}" class='permission' id="permission_{{ $permission->name }}">
                                                    </td>
                                                    <td><span for="permission_{{ $permission->name }}">{{ ucwords(str_replace('.',' ',$permission->name)) }}</span></td>
